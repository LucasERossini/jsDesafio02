...
//! Función para agregar pruducto a la lsita
function list(prod) {
    switch (prod) {
    case 1: 
        lista = lista + "\n-Producto 1: $10";
...
//! Función para sumar el producto elegido y sumarlo a la lsita
...
if (prod == 0) {
    ...
    while ((prod != 0)) {
        //! Condicional para restringir ingresos a opciones válidas
        if (prod >=5) {
